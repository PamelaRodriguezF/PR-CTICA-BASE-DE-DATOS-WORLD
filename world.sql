...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-08-2020 a las 04:10:34
...
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `cityPopulation`) VALUES
...
INSERT INTO `country` (`Code`, `CountryName`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES
